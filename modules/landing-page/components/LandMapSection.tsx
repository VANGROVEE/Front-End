...
const customIcon = new L.Icon({
  iconUrl: "https://cdn-icons-png.flaticon.com/512/684/684908.png", // Gantilah dengan icon hijau Anda
  iconSize: [38, 38],
  iconAnchor: [19, 38],
  popupAnchor: [0, -38],
});
...
export default function LandMapSection() {
  const centerPosition = [-6.2, 106.816666]; // Contoh Koordinat Jakarta/Pusat Lahan
