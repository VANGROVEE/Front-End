...
export const PlantingCycleSchema = z
  .object({
...
export const createPlantingCycleSchema = z.object({
  body: PlantingCycleSchema,
});

export const updateUserDtoSchema = PlantingCycleSchema.partial().refine(
...
export type UpdatePlantingCycleDto = z.infer<typeof PlantingCycleSchema>;
