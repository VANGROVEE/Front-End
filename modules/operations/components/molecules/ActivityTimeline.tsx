    ...
    <Card className="rounded-[32px] border-none bg-white shadow-sm flex-1 overflow-hidden">
      <CardHeader className="flex flex-row items-center justify-between px-8 pt-8 pb-6">
        ...
        <Button
          ...
          variant="secondary"
          size="sm"
          className="h-9 rounded-2xl bg-green-50 text-green-700 hover:bg-green-100 font-black text-[11px] px-5 transition-all active:scale-95"
        >
      ...
      <CardContent className="px-8 pb-10">
        {activities.length === 0 ? (
          <div className="h-64 flex flex-col items-center justify-center text-slate-300 gap-3 border-2 border-dashed border-slate-50 rounded-[24px]">
            ...
            <div className="text-center">
              ...
              <p className="text-[11px] font-medium text-slate-300">
                Mulai catat aktivitas harian untuk analisis AI
              </p>
            </div>
          </div>
        ) : (
              ...
              >
                ...
                <div className="w-[calc(100%-3.5rem)] md:w-[calc(50%-2.5rem)] bg-white p-6 rounded-[24px] border border-slate-100 shadow-sm group-hover:border-green-200 group-hover:shadow-md transition-all duration-300">
                  <div className="flex justify-between items-center mb-3">
                    <Badge
                      className={cn(
                        "border-0 text-[10px] font-black uppercase tracking-wider px-2.5 py-0.5",
